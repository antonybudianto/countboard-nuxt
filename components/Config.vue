<template>
  <div class="mx-3 my-2 md:px-0 min-h-screen">
    ...
    <div class="mt-5 dark:text-cyan-50">
      ...
      <button
        type="button"
        class="text-white bg-gray-800 w-1/5 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
        @click="handleLoad"
      >
        Load
      </button>
